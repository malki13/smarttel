...
public class FacturaInfo {
    ...
    private ClienteInfoOnly clienteInfo;
    ...
    public ClienteInfoOnly getClienteInfo() {
        return clienteInfo;
    }

    public void setClienteInfo(ClienteInfoOnly clienteInfo) {
    ...
    public List<AnexoInfo> getAnexos() {
        return anexos;
    }

    public void setAnexos(List<AnexoInfo> anexos) {
        this.anexos = anexos;
    }
